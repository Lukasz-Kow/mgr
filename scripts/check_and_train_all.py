...
TRAIN_CONFIGS = {
    ...
    'hybrid':        'configs/hybrid_config.yaml',
    'selective_net': 'configs/selectivenet_config.yaml',
    'evidential':    'configs/evidential_config.yaml',
}
...
def main():
    ...
    print("=" * 70)
    print("  MASTER PIPELINE: CHECK → TRAIN → EVALUATE [MONAI]")
    print("=" * 70)
    ...
    subprocess.run([sys.executable, 'scripts/training_summary.py'], check=False)
